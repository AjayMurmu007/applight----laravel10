    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <a href="{{ url('admin/our_team/list/'. @$getRecord[0]->id)}}" class="btn btn-primary" style="margin-bottom: 15px">Add Our Team</a>
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  ...
                  <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form  method="POST" action="{{ url('admin/our_team/post') }}" enctype="multipart/form-data">
