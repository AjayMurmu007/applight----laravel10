                ...
                <div class="row">
                    ...
                    <form  method="POST" action="" enctype="multipart/form-data">
                      ...
                      <div class="card-body">
                        ...
                        <input type="hidden" name="our_team_id" value="{{ $getRecord->id }}">
                        ...
                        <div class="form-group">
                            ...
                            @if($getRecord->image)
                                <img src="{{ url('public/testimonial/' . $getRecord->image) }}" width="150" height="150">
                            @endif
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" required name="position_name" value="{{ $getRecord->position_name }}">
                            <span style="color: red;"> {{ $errors -> first('position_name') }} </span>
                        </div> 
                        
                        <div class="form-group">
                            <label>Discription <span style="color: red;">*</span> </label>
                            <textarea type="text" class="form-control" name="discription" cols="10" rows="5"> {{ $getRecord->discription }} </textarea>
