    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <a href="{{ url('admin/testimonial/list')}}" class="btn btn-primary" style="margin-bottom: 15px">Add Testimonial</a>
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  ...
                  <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form  method="POST" action="{{ url('admin/testimonial/post') }}" enctype="multipart/form-data">
