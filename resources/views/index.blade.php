...
<title> {{ @$getSEO[0]->meta_title }} </title>
{{-- APPLight --}}

<meta name="description" content="{{ @$getSEO[0]->meta_discription }}">
<meta name="og:description" content="{{ @$getSEO[0]->meta_discription }}">

<meta name="keyword" content="{{ @$getSEO[0]->meta_keyword }}">
<meta name="og:keyword" content="{{ @$getSEO[0]->meta_keyword }}">
...
<link rel="stylesheet" type="text/css" href="{{ url('public/frontend/style.css') }}"/>
...
<nav class="navbar navbar-expand-lg">
  <div class="container"> <a class="navbar-brand navbar-logo" href="#"> <img src="{{ url('public/frontend/images/logo.png') }}" alt="logo" class="logo-1"> </a>
      ...
      <div class="row">
        <div class="col-md-8 col-sm-12">
          <div class="banner-text">
            ...
            <p class="banner-text white">{{ $getRecord[0]->discription }}</p>
            <ul>
              <li><a href="{{ $getRecord[0]->google_play }}" target="_blank"> <img src="{{ url('public/img/'. @$getRecord[0]->image_one) }}" class="wow fadeInUp" data-wow-delay="0.4s"/></a></li>
              <li><a href="{{ $getRecord[0]->app_store }}" target="_blank"> <img src="{{ url('public/img/'. @$getRecord[0]->image_two) }}" class="wow fadeInUp" data-wow-delay="0.7s"/></a></li>
            </ul>
          </div>
        </div>
            ...
            <div class="col-md-4 col-sm-12">
              <div class="media single-feature wow fadeInUp" data-wow-delay="0.2s">
                <div class="media-body text-right media-right-margin">
                  ...
                  <p>{{ @$getFeatures[0]->discription_one }}</p>
                </div>
              ...
              <div class="media single-feature wow fadeInUp" data-wow-delay="0.4s">
                <div class="media-body text-right media-right-margin">
                  ...
                  <p>{{ @$getFeatures[0]->discription_two }}</p>
                </div>
              ...
              <div class="media single-feature wow fadeInUp" data-wow-delay="0.6s">
                <div class="media-body text-right media-right-margin">
                  ...
                  <p>{{ @$getFeatures[0]->discription_three }}</p>
                </div>
            ...
            <div class="col-md-4 d-none d-md-block d-lg-block">
              <div class="feature-mobile"> 
                ...
                @if(@$getFeatures[0]->image)
                  <img src="{{ url('public/feature/' . $getFeatures[0]->image) }}" class="img-fluid wow fadeInUp"/>
                @endif 
            ...
            <div class="col-md-4 col-sm-12">
              <div class="media single-feature wow fadeInUp" data-wow-delay="0.2s">
                ...
                <div class="media-body text-left">
                  ...
                  <p>{{ @$getFeatures[0]->discription_four }}</p>
                </div>
              </div>
              <div class="media single-feature wow fadeInUp" data-wow-delay="0.4s">
                ...
                <div class="media-body text-left">
                  ...
                  <p>{{ @$getFeatures[0]->discription_five }}</p>
                </div>
              </div>
              <div class="media single-feature wow fadeInUp" data-wow-delay="0.6s">
                ...
                <div class="media-body text-left">
                  ...
                  <p>{{ @$getFeatures[0]->discription_six }}</p>
                </div>
              </div>
            </div>
          </div>
...
<section class="team section-padding" data-scroll-index='3'>
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <div class="sectioner-header text-center">
          <h3>{{ $getOutTeam[0]->title}}</h3>
          <span class="line"></span>                                          
          <p>{{ $getOutTeam[0]->discription}}</p>
        </div>
        <div class="section-content text-center">
          <div class="row">

            @foreach ($getOurTeamPosition as $value)
                
            <div class="col-md-4">
              <div class="team-detail wow bounce" data-wow-delay="0.2s"> <img src="{{ url('public/img/'. $value->image) }}" class="img-fluid"/>
                <h4>{{ $value->name }}</h4>
            ...
            @endforeach
            {{-- <div class="col-md-4">
              <div class="team-detail wow bounce" data-wow-delay="0.4s"> <img src="{{ url('public/img/'. $getOurTeamPosition[1]->image) }}" class="img-fluid"/>
                <h4>{{ $getOurTeamPosition[1]->name }}</h4>
                <p>{{ $getOurTeamPosition[1]->position_name }}</p>
              </div>
            </div>
            <div class="col-md-4">
              <div class="team-detail wow bounce" data-wow-delay="0.6s"> <img src="{{ url('public/img/'. $getOurTeamPosition[2]->image) }}" class="img-fluid"/>
                <h4>{{ $getOurTeamPosition[2]->name }}</h4>
                <p>{{ $getOurTeamPosition[2]->position_name }}</p>
              </div>
            </div> --}}
          </div>
        </div>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="sectioner-header text-center white">
          <h3> {{ $getTestimonial[0]->title }} </h3>
          <span class="line"></span>
          <p class="white">  {{ $getTestimonial[0]->discription }} </p> 
        </div>
        ...
        <div class="row">
          <div class="offset-md-2 col-md-8 col-sm-12">
            <div class="slider">
              ...
              @foreach($getTestimonialDetail as $value)
                  
              
              <div class="slider-item">
                <div class="test-img"><img src="{{ url('public/testimonial/'. $value->image) }}" alt="Placeholder" width="157" height="157"></div>
                <div class="test-text"><span class="title"><span> {{ $value->name }} </span> {{ $value->position_name }} </span> {{ $value->discription }} </div>
              </div>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="sectioner-header text-center">
          ...
          <span class="line"></span>
          <p> {{ $getFAQ[0]->discription }} </p>
        </div>
        <div class="section-content">
          <div class="row">

            @foreach ($getFaqDetail as $value)
        ...
        <div class="section-content">
          ...
          <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-8">
              ...
              <form id="contact_form" action="{{ url('contact/post')}}" method="post">
              ...
              <div class="contact-info white">
                ...
                <div class="contact-item media"> <i class="fa fa-envelope media-left media-right-margin"></i>
                  <div class="media-body">
                    ...
                    <p class="text-uppercase"><a class="text-white" href="mailto:abcdefg@gmail.com"> {{ $getContact[0]->email2 }} </a> </p>
                  </div>
                </div>
...
<section class="download section-padding">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <div class="sectioner-header text-center white">
          <h3> {{ @$getdownloadourapp[0]->title }} Download Our App</h3>
          <span class="line"></span>
          <p class="white"> {{ @$getdownloadourapp[0]->discription }}</p>
        </div>
      </div>
      <div class="col-md-12">
        <div class="section-content text-center">
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-12"> 
        ...
        <p> {{ @$getSEO[0]->website_developer }} </p>
      </div>
    </div>
  </div>
</footer>
